...
var app = (function () {
    ...
    function create_default_slot_3$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "link svelte-zjf1gm");
    			add_location(span, file$4, 7, 6, 134);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "link svelte-zjf1gm");
    			add_location(span, file$4, 10, 6, 218);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(10:4) <Link class=\\\"link\\\" to=\\\"login\\\">",
    		ctx
    	});
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "link svelte-zjf1gm");
    			add_location(span, file$4, 13, 6, 303);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:4) <Link class=\\\"link\\\" to=\\\"about\\\">",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(nav, "class", "navbar svelte-zjf1gm");
    			add_location(nav, file$4, 5, 2, 89);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$3, 10, 8, 225);
    			attr_dev(input0, "class", "uk-input");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$3, 11, 8, 284);
    			attr_dev(div0, "class", "uk-inline");
    			add_location(div0, file$3, 9, 6, 193);
    			attr_dev(div1, "class", "uk-margin");
    			add_location(div1, file$3, 8, 4, 163);
    			attr_dev(span1, "class", "uk-form-icon");
    			attr_dev(span1, "uk-icon", "icon: lock");
    			add_location(span1, file$3, 16, 8, 435);
    			attr_dev(input1, "class", "uk-input");
    			attr_dev(input1, "type", "password");
    			add_location(input1, file$3, 17, 8, 494);
    			attr_dev(div2, "class", "uk-inline");
    			add_location(div2, file$3, 15, 6, 403);
    			attr_dev(div3, "class", "uk-margin");
    			add_location(div3, file$3, 14, 4, 373);
    			attr_dev(button, "class", "uk-button uk-button-primary uk-button-small");
    			set_style(button, "width", "100%");
    			add_location(button, file$3, 21, 6, 618);
    			attr_dev(div4, "class", "uk-margin ");
    			add_location(div4, file$3, 20, 4, 587);
    			attr_dev(fieldset, "class", "uk-fieldset");
    			add_location(fieldset, file$3, 6, 2, 74);
    			attr_dev(form, "class", "form svelte-1krd8dn");
    			add_location(form, file$3, 5, 0, 52);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Components/TestComp/Comp.svelte generated by Svelte v3.48.0 */

    const file$2 = "src/Components/TestComp/Comp.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			button = element("button");
    			t4 = text(/*buttonText*/ ctx[1]);
    			add_location(h1, file$2, 11, 2, 144);
    			add_location(button, file$2, 13, 2, 170);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*buttonText*/ 2) set_data_dev(t4, /*buttonText*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Comp', slots, []);
    	let { name } = $$props;
    	let buttonText = "Button";

    	function handleClick() {
    		$$invalidate(1, buttonText = "Button Clicked");
    	}

    	const writable_props = ['name'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Comp> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ name, buttonText, handleClick });
    	...
    	return [name, buttonText, handleClick];
    }

    class Comp extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*name*/ ctx[0] === undefined && !('name' in props)) {
    			console.warn("<Comp> was created without expected prop 'name'");
    		}
    	}

    	get name() {
    		throw new Error("<Comp>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set name(value) {
    		throw new Error("<Comp>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/Components/Routes.svelte generated by Svelte v3.48.0 */
    const file$1 = "src/Components/Routes.svelte";
    ...
    function create_default_slot_3(ctx) {
    	...
    	let comp;
    	let current;
    	comp = new Comp({ props: { name: "world" }, $$inline: true });
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 12, 4, 267);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 17, 4, 338);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router: Router$1, Route: Route$1, Link: Link$1, Login, Comp });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 7, 2, 186);
    			attr_dev(a0, "href", "https://svelte.dev");
    			add_location(a0, file, 13, 10, 249);
    			add_location(p0, file, 12, 2, 235);
    			attr_dev(a1, "href", "https://github.com/sveltejs/kit#readme");
    			add_location(a1, file, 18, 14, 360);
